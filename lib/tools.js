...
const TOOLS = [
  {
    name: "smart_search",
    description:
      "一次性快速搜索，调用 smart-search search 命令，并按本适配器策略限制 provider：网页补强只用 Tavily -> Firecrawl，文档补强只用 Exa。适合简单查询，不适合深度调研、核验、多步取证等复杂任务；这些任务应优先使用 smart_deep_research。",
    inputSchema: {
      type: "object",
      properties: {
        ...
        extra_sources: {
          type: "number",
          description: "补充来源数（0=不补充，1-5=额外调用 Tavily/Firecrawl；默认 3）",
          default: 3,
        },
        validation: {
          type: "string",
